 ...
 */
public class TarotFragmentCareer extends Fragment {
    ...
    public TarotFragmentCareer() {}

    public static TarotFragmentCareer newInstance() {
        return new TarotFragmentCareer();
    }
    ...
    private void fetchTarotsFromFirestore() {
        executorService.execute(() -> {
            firestore.collection("tarotCareerDescription")
                    .get()
